...
//退出游戏
interface exitminiProgramObject
{
  success?:Function;
  fail?:Function;
  complete?:Function;
...
//获取小游戏启动时的参数
interface _getLaunchOptionsSyncObject
{
  scene:number;
  ...
  referrerInfo:_referrerInfoData;
}

interface _referrerInfoData
{
  appId	:string;
  extraData:Object;
}
...
//分享所需数据
interface _MenueButtonBoundingInfo{
 ...
 */
  ...
  * @param object 
  */
 export function exitMiniProgram(object:exitminiProgramObject):void;
  ...
  // //阿拉丁消息事件
   export function aldSendEvent(eventname:string,eventObj?:Object);
  
  //显示
  export function onShow(callback:Function);

  //获取右上角坐标信息
  export function getMenuButtonBoundingClientRect():_MenueButtonBoundingInfo;
  ...
  /**
	* 创建 奖励banner 广告组件 
	*/
  export function createGameBanner(object:Object):BannerAd;

  //创建插屏广告奖励
  export function createInterstitialAd(object:Object):InterstitialAd;

  /**
	* 返回小程序启动参数 
	*/
	export function getLaunchOptionsSync(): _getLaunchOptionsSyncObject;


  //创建跳转游戏Icon
  export function createGameIcon(object:Object ,styleItem: Object ):GameIcon;
